...
if [[ "$BRANCH" = "develop" ]]; then
      git clone https://github.com/usdot-fhwa-stol/carma-msgs.git ~/src/CARMAMsgs --branch carma-system-3.6.0
      git clone https://github.com/usdot-fhwa-stol/carma-utils.git ~/src/CARMAUtils --branch carma-system-3.6.0
else
